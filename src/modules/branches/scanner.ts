...
import type { BranchesOptions, BranchesData, RepoHygieneConfig } from '../../types/index.js';
...
export class BranchesScanner extends BaseScanner<BranchesOptions, BranchesData> {
  constructor(gitContext: GitContext, config: RepoHygieneConfig, options: BranchesOptions = {}) {
