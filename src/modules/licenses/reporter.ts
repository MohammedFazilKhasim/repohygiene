 ...
 */
export function generateCsvReport(licenses: readonly DependencyLicense[]): string {
  const lines: string[] = ['Package,Version,License,Status,Production,Repository'];
 ...
 */
export function generateNoticeFile(licenses: readonly DependencyLicense[]): string {
  const lines: string[] = [
