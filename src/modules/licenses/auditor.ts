...
import type { LicenseOptions, LicenseData, RepoHygieneConfig } from '../../types/index.js';
...
export class LicenseAuditor extends BaseScanner<LicenseOptions, LicenseData> {
  ...
  constructor(gitContext: GitContext, config: RepoHygieneConfig, options: LicenseOptions = {}) {
