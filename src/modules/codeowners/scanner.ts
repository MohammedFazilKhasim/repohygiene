...
import type { CodeownersOptions, CodeownersData, RepoHygieneConfig } from '../../types/index.js';
...
export class CodeownersScanner extends BaseScanner<CodeownersOptions, CodeownersData> {
  constructor(gitContext: GitContext, config: RepoHygieneConfig, options: CodeownersOptions = {}) {
