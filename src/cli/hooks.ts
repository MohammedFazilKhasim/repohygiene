 ...
 */
export function installAllHooks(repoPath: string): Array<{ hook: string; result: { success: boolean; message: string } }> {
    const results = [];
 ...
 * Uninstall all hooks
 */
export function uninstallAllHooks(repoPath: string): Array<{ hook: string; result: { success: boolean; message: string } }> {
    const results = [];
